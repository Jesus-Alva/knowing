...
@section('contenido')
                ...
                <div class="flex items-center gap-2">
                    ...
                    @auth
                        @if ($user->id === auth()->user()->id)
                            <a href="{{ route('perfil.index') }}" class="text-gray-400 hover:text-gray-700 cursor-pointer">
    ...
    <section>
        ...
        @else
            <a class="text-gray-600 uppercase text-sm flex justify-center font-bold">Aun no hay posts</a>
        @endif
    </section>
@endsection