...
@section('contenido')
    <div class="container mx-auto md:flex">
        <div class="md:w-1/2 p-5">
            <img src="{{asset('uploads') . '/' . $post->imagen}}" alt="Imagen del post {{$post->imagem}}">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">
                    <!--Obtenido de laravel carbon library, diffForHumans formatea la fecha-->
